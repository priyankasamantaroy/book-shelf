        ...
        return (
            ...
            {this.state.searchBooks.map((book)=>(
                         ...
                         <div className="book">
                            ...
                            {books.map((rackbook)=>(rackbook.id===book.id ? 
                                  <option value="none">None</option> 
                                  {bookShelves.map((bookshelf)=> (bookshelf===rackbook.shelf ? <option value={bookshelf} selected >{bookshelf}</option> : <option value={bookshelf}>{bookshelf}</option>))}
                              : 
